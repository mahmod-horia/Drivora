...
namespace drivora
{
    public partial class frmuser : Form
    {
        ...
        {
            messegebox2 show = new messegebox2();
            show.Show();
            this.Hide();
        }
        ...
        {
            carlist show = new carlist() { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
            showfrm2(show);
        }

        private void button3_Click(object sender, EventArgs e)
        {
            chatfrm show = new chatfrm() { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
            showfrm2(show);
        }
    }
}
